...
//**********Процедура добовляет существ. узел в дерево хаффмана**************//
...
//**********ФУНКЦИЯ СОЗДЁТ УЗЕЛ И ДОБАВЛЯЕТ ЕГО В ДЕРЕВО*********//
function TNodeList.AddNode: TNode;
begin
 Result := FNodeClass.Create; //СОЗДАЁМ УЗЕЛ
 AddCreated(Result);          //ДОБАВЛЯЕМ В ДЕРЕВО
end;
//**************************************************************//
...
//********Процедура присоеденяет узел к дереву********//
...
///*****Процедура удаляет лист из дерева****///
